...
# Set variables
start_date="$input_year-08-20"
end_date="$input_year-011-20"
total_commits=106        # Total commits to generate (multiple per day allowed)
...
generate_holidays() {
    ...
    holidays=(
        ...
        "$year-01-05"
        "$year-01-06"
        "$year-01-07"   # EDSA People Power Revolution
        "$year-04-05"   # Araw ng Kagitingan
        "$year-04-06"   # Labor Day
        "$year-05-01"   # Independence Day
        "$year-05-03"   # Ninoy Aquino Day
        "$year-05-24"   # All Saints' Day
        "$year-05-25"   # All Saints' Day
        "$year-06-04"   # Bonifacio Day
        "$year-08-15"   # Bonifacio Day
        "$year-08-16"   # Bonifacio Day
        "$year-11-01"   # Bonifacio Day
        "$year-11-02"   # Bonifacio Day
        "$year-11-11"   # Bonifacio Day
        "$year-11-12"   # Bonifacio Day
